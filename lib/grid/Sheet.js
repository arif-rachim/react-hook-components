...
export default function Sheet(props) {
    ...
    const [$defaultRowHeight,] = useObserver(DEFAULT_HEIGHT);
    const [$defaultColWidth,] = useObserver(DEFAULT_WIDTH);
    const [$viewPortDimension, setViewPortDimension] = useObserver({ width: 0, height: 0 });
    const [$scrollerPosition, setScrollerPosition] = useObserver({ left: ((_a = props.$scrollLeft) === null || _a === void 0 ? void 0 : _a.current) || 0, top: ((_b = props.$scrollTop) === null || _b === void 0 ? void 0 : _b.current) || 0 });
