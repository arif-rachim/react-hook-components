...
export function CellComponentForColumnHeader(props) {
    ...
    return React.createElement(Vertical, { style: { height: '100%' } },
        React.createElement(Horizontal, { style: { flexGrow: 1, padding: '0px 5px', backgroundColor: '#eee', color: '#333' }, vAlign: 'center', onClick: handleSortClicked },
            React.createElement(Vertical, null, props.title),
            shouldHaveFilter &&
...
export function Grid(gridProps) {
    ...
    const [$customColWidth, setCustomColWidth] = useObserver(new Map());
    ...
    const gridHeaderRef = useRef({ setScrollerPosition: () => { } });
    const gridLeftPinnedRef = useRef({ setScrollerPosition: () => { } });
    const gridRowResizerRef = useRef({ setScrollerPosition: () => { } });
    ...
    const headerData = useMemo(constructHeaderData(columnsProp), []);
    ...
    const columnsHeaderColumn = useObserverValue($columns, (columns) => {
        return columns.map((c) => (Object.assign(Object.assign({}, c), { cellComponent: CellComponentForColumnHeaderBase, cellSpanFunction: props => {
                let rowSpan = 1;
                let colSpan = 1;
                ...
                React.createElement(Horizontal, { style: { height: '100%', flexGrow: 1, overflow: 'auto', position: 'relative' } },
                    React.createElement(ObserverValue, { observers: [$pinnedLeftColumnWidth], render: () => {
                            return React.createElement(Vertical, { style: {
                                ...
                                React.createElement(Sheet, { data: headerData, columns: columnsHeaderColumn.filter((value, index) => index <= pinnedLeftColumnIndex), "$customColWidth": $customColWidth, styleContainer: { width: '100%' }, showScroller: false, defaultRowHeight: HEADER_HEIGHT, defaultColWidth: defaultColWidth, hideLeftColumnIndex: -1 }));
                        } }),
                    React.createElement(Vertical, { style: { flexGrow: 1, overflow: 'auto' } },
                        React.createElement(Sheet, { data: headerData, ref: gridHeaderRef, columns: columnsHeaderColumn, "$customColWidth": $customColWidth, showScroller: false, defaultRowHeight: HEADER_HEIGHT, defaultColWidth: defaultColWidth, hideLeftColumnIndex: pinnedLeftColumnIndex })))),
            React.createElement(Horizontal, { style: { height: `calc(100% - ${HEADER_HEIGHT}px)`, width: '100%', overflow: 'auto' } },
                ...
                React.createElement(Horizontal, { style: { height: '100%', flexGrow: 1, overflow: 'auto', position: 'relative' } },
                    React.createElement(ObserverValue, { observers: [$pinnedLeftColumnWidth, $data, $columns], render: () => {
                            return React.createElement(Vertical, { style: {
                                ...
                                React.createElement(Sheet, { ref: gridLeftPinnedRef, data: $data.current, columns: $columns.current.filter((value, index) => index <= pinnedLeftColumnIndex), "$customRowHeight": $customRowHeight, "$customColWidth": $customColWidth, showScroller: false, defaultColWidth: defaultColWidth, styleContainer: { width: '100%' }, defaultRowHeight: defaultRowHeight, onCellClicked: event => {
                    ...
                    React.createElement(Vertical, { ref: viewportRef, style: { height: '100%', flexGrow: 1, overflow: 'auto' } },
                        React.createElement(ObserverValue, { observers: [$data, $columns], render: () => {
                                return React.createElement(Sheet, { data: $data.current, columns: $columns.current, "$customRowHeight": $customRowHeight, "$customColWidth": $customColWidth, onScroll: ({ scrollLeft, scrollTop }) => {
                                    ...
                                    }, "$focusedDataItem": $focusedDataItem, hideLeftColumnIndex: pinnedLeftColumnIndex });
                            } }))))));
}
