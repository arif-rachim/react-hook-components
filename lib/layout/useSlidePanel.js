...
export function useSlidePanel() {
    ...
    return useMemo(() => {
        ...
        function SlidePanel(props) {
            ...
            return React.createElement(Vertical, Object.assign({ ref: containerRef, overflow: "hidden", position: "relative", backgroundColor: 'rgba(0,0,0,0.1)', style: style }, properties),
                props.children,
